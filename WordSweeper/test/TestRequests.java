		...
		Message m = new Message (
				responseHeader +
				  "<boardResponse gameId='hg12jhd' managingUser='player2' bonus='4,3'>" +
				      "<player name='player1' score='3897498374' position='4,6' board='AFERKSOEROIERPOR'/>" +
				      "<player name='player2' score='98127398' position='2,2' board='ECDRFTGOUIGERPRT'/>" +
				  "</boardResponse>" +
				"</response>");
		System.out.println(m.toString());
	}
		...
		Message m = new Message (
				responseHeader +
				  "<boardResponse gameId='hg12jhd' managingUser='player2' bonus='4,3' contents='ABCGBCJDH...HDJHJD'>" +
				      "<player name='player1' score='392489038' position='4,6' board='AFERKSOEROIERPOR'/>" +
				      "<player name='player2' score='38974' position='2,2' board='ECDRFTGOUIGERPRT'/>" +
				  "</boardResponse>" +
				"</response>");
	}
